...
voltage_tests = set(["Power Continuity"])
resistance_tests = set(["Positive Circuit Continuity", "Negative Circuit Continuity", "Inline-Resistor", "Isolation Chasis", "Isolation"])
isolation_tests = set(["Isolation Chasis", "Isolation"])
...
def pop_information(message):
    QMessageBox.information(None,"",message)

def pop_critical(message):
