...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.navigation_pane = NavigationPane(self.test_template)
        ...
        self.stacked_layout.addWidget(QPushButton("Left-Most"))
        ...
        self.navigation_pane = NavigationPane(self.test_template)
        self.stacked_layout.addWidget(QPushButton("Left-Most"))
        self.stacked_layout.addWidget(self.navigation_pane)
